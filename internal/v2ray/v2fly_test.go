...
import (
	...
	mockCommand "github.com/anonopiran/Fly2Stats/mocks/github.com/v2fly/v2ray-core/v5/app/stats/command"
)

var _ = Describe("V2flyServerType", func() {
	var (
	...
	BeforeEach(func() {
		...
		server = v2ray.NewV2flyServer(config.UpstreamUrlType{})
		server.IServer = &v2ray.V2flyServerType{
